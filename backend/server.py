...
async def get_products(
    ...
    if search:
        ...
        fields = ["name", "brand", "model", "category", "description", "sku", "oem_kodu"]
        if len(terms) == 1:
...
DEMO_PRODUCTS = [
    {"name": "Honda PCX 125 Ön Fren Balata Takımı (15-17)", "slug": "honda-pcx125-1517-on-fren-balata",
     ...
     "year_range": "2015-2017", "category": "Fren Sistemi", "stock": 15, "sku": "HP-PCX-1517-FB001",
    ...
    {"name": "Honda PCX 125 Hava Filtresi (15-17)", "slug": "honda-pcx125-1517-hava-filtresi",
     ...
     "brand": "HONDA", "model": "PCX 125", "model_id": "honda-pcx125-1517",
     "year_range": "2015-2017", "category": "Filtreler", "stock": 22, "sku": "HP-PCX-1517-HF001",
     "oem_kodu": "17211-K97-V01", "is_featured": False},
    {"name": "Honda PCX 125 Motor Yağı Filtresi (15-17)", "slug": "honda-pcx125-1517-yag-filtresi",
     ...
     "brand": "HONDA", "model": "PCX 125", "model_id": "honda-pcx125-1517",
     "year_range": "2015-2017", "category": "Filtreler", "stock": 45, "sku": "HP-PCX-1517-YF001",
     "oem_kodu": "15412-MJ0-003", "is_featured": False},
    {"name": "Honda PCX 125 Sağ Sol Ayna Seti (15-17)", "slug": "honda-pcx125-1517-ayna-seti",
     ...
     "brand": "HONDA", "model": "PCX 125", "model_id": "honda-pcx125-1517",
     "year_range": "2015-2017", "category": "Aksesuar", "stock": 8, "sku": "HP-PCX-1517-AY001",
     "oem_kodu": "88110-KZV-J01", "is_featured": True},
    {"name": "Honda PCX 125 Vites Kayışı (18-20)", "slug": "honda-pcx125-1820-vites-kayisi",
     ...
     "year_range": "2018-2020", "category": "Motor & Şanzıman", "stock": 12, "sku": "HP-PCX-1820-VK001",
     "oem_kodu": "23100-K35-V01", "is_featured": True},
    {"name": "Honda PCX 125 Ön Far LED Set (18-20)", "slug": "honda-pcx125-1820-on-far-led",
     ...
     "image": "https://images.unsplash.com/photo-1534755563369-ad37931ac77b?w=600&q=80",
     "brand": "HONDA", "model": "PCX 125", "model_id": "honda-pcx125-1820",
     "year_range": "2018-2020", "category": "Elektrik & Aydınlatma", "stock": 6, "sku": "HP-PCX-1820-FL001",
     "oem_kodu": "33100-K35-V01", "is_featured": False},
    {"name": "Honda PCX 125 Kaporta Koruyucu Set (18-20)", "slug": "honda-pcx125-1820-kaporta-koruyucu",
     ...
     "image": "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&q=80",
     "brand": "HONDA", "model": "PCX 125", "model_id": "honda-pcx125-1820",
     "year_range": "2018-2020", "category": "Kaporta & Plastik", "stock": 10, "sku": "HP-PCX-1820-KK001",
     "oem_kodu": "64300-K35-V01", "is_featured": False},
    {"name": "Honda PCX 125 ABS Fren Seti (21-24)", "slug": "honda-pcx125-2124-abs-fren",
     ...
     "year_range": "2021-2024", "category": "Fren Sistemi", "stock": 5, "sku": "HP-PCX-2124-AB001",
     "oem_kodu": "45100-K3A-J01", "is_featured": True},
    {"name": "Honda DIO 110 Hava Filtresi (21-24)", "slug": "honda-dio110-2124-hava-filtresi",
     ...
     "year_range": "2021-2024", "category": "Filtreler", "stock": 30, "sku": "HD-DIO-2124-HF001",
     "oem_kodu": "17210-K2E-V01", "is_featured": False},
    {"name": "Honda CBF 150 Zincir Dişli Seti", "slug": "honda-cbf150-zincir-disli",
     ...
     "year_range": "", "category": "Aktarma Organları", "stock": 10, "sku": "HC-CBF-150-ZD001",
     "oem_kodu": "40530-KPR-900", "is_featured": True},
    {"name": "Honda FORZA 250 Arka Amortisör", "slug": "honda-forza250-arka-amortisoru",
     ...
     "year_range": "", "category": "Süspansiyon", "stock": 4, "sku": "HF-FRZ-250-AA001",
     "oem_kodu": "52400-MKA-J01", "is_featured": True},
    {"name": "Honda ACTIVA 125 Karbüratör Sifonu", "slug": "honda-activa125-karburator-sifonu",
     ...
     "year_range": "", "category": "Yakıt Sistemi", "stock": 22, "sku": "HA-ACT-125-KS001",
    ...
    {"name": "Yamaha NMAX 125 Ön Fren Diski", "slug": "yamaha-nmax125-on-fren-diski",
     ...
     "year_range": "", "category": "Fren Sistemi", "stock": 18, "sku": "YN-NMX-125-FD001",
     "oem_kodu": "3D8-F5820-00", "is_featured": True},
    {"name": "Yamaha NMAX 125 Buji Takımı", "slug": "yamaha-nmax125-buji",
     ...
     "image": "https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=600&q=80",
     "brand": "YAMAHA", "model": "NMAX 125", "model_id": "yamaha-nmax125",
     "year_range": "", "category": "Motor & Şanzıman", "stock": 55, "sku": "YN-NMX-125-BJ001",
     "oem_kodu": "BPR5ES-11", "is_featured": False},
    {"name": "Yamaha NMAX 155 Akü 12V 7AH", "slug": "yamaha-nmax155-aku",
     ...
     "year_range": "", "category": "Elektrik & Aydınlatma", "stock": 9, "sku": "YN-NMX-155-AK001",
     "oem_kodu": "GM7Z-3B", "is_featured": False},
    {"name": "Yamaha NMAX 155 Spor Egzoz", "slug": "yamaha-nmax155-spor-egzoz",
     ...
     "image": "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&q=80",
     "brand": "YAMAHA", "model": "NMAX 155", "model_id": "yamaha-nmax155",
     "year_range": "", "category": "Egzoz", "stock": 6, "sku": "YN-NMX-155-EG001",
     "oem_kodu": "2DP-14610-00", "is_featured": True},
    {"name": "Yamaha XMAX 250 Ön Amortisör Seti", "slug": "yamaha-xmax250-on-amortisoru",
     ...
     "year_range": "", "category": "Süspansiyon", "stock": 3, "sku": "YX-XMX-250-OA001",
     "oem_kodu": "2DP-23100-00", "is_featured": True},
    {"name": "Yamaha XMAX 250 Fren Kaliper Seti", "slug": "yamaha-xmax250-fren-kaliperi",
     ...
     "image": "https://images.unsplash.com/photo-1534755563369-ad37931ac77b?w=600&q=80",
     "brand": "YAMAHA", "model": "XMAX 250", "model_id": "yamaha-xmax250",
     "year_range": "", "category": "Fren Sistemi", "stock": 4, "sku": "YX-XMX-250-FK001",
     "oem_kodu": "2MB-F580W-00", "is_featured": False},
    {"name": "CFMoto NK250 Ön Fren Balata", "slug": "cfmoto-nk250-on-fren-balata",
     ...
     "year_range": "", "category": "Fren Sistemi", "stock": 20, "sku": "CF-NK250-FB001",
     "oem_kodu": "CF188A-064000", "is_featured": False},
    {"name": "CFMoto NK250 Motor Yağı Filtresi", "slug": "cfmoto-nk250-yag-filtresi",
     ...
     "image": "https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=600&q=80",
     "brand": "CFMOTO", "model": "NK250", "model_id": "cfmoto-nk250",
     "year_range": "", "category": "Filtreler", "stock": 35, "sku": "CF-NK250-YF001",
     "oem_kodu": "CF188A-011200", "is_featured": False},
    {"name": "CFMoto 250SR Fren Kaliperi Seti", "slug": "cfmoto-250sr-fren-kaliperi",
     ...
     "year_range": "", "category": "Fren Sistemi", "stock": 5, "sku": "CF-250SR-FK001",
     "oem_kodu": "CF250T-080000", "is_featured": True},
    {"name": "Bajaj NS200 Zincir Dişli Seti", "slug": "bajaj-ns200-zincir-disli",
     ...
     "year_range": "", "category": "Aktarma Organları", "stock": 14, "sku": "BJ-NS200-ZD001",
     "oem_kodu": "2ML-F350Z-00", "is_featured": True},
    {"name": "Bajaj NS200 LED Sinyal Seti", "slug": "bajaj-ns200-led-sinyal",
     ...
     "image": "https://images.unsplash.com/photo-1534755563369-ad37931ac77b?w=600&q=80",
     "brand": "BAJAJ", "model": "NS200", "model_id": "bajaj-ns200",
     "year_range": "", "category": "Elektrik & Aydınlatma", "stock": 25, "sku": "BJ-NS200-LS001",
     "oem_kodu": "33400-MCA-S01", "is_featured": False},
    {"name": "Bajaj NS200 Fren Balata Seti (Ön+Arka)", "slug": "bajaj-ns200-fren-balata-seti",
     ...
     "image": "https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=600&q=80",
     "brand": "BAJAJ", "model": "NS200", "model_id": "bajaj-ns200",
     "year_range": "", "category": "Fren Sistemi", "stock": 18, "sku": "BJ-NS200-FB001",
     "oem_kodu": "06435-MCA-J01", "is_featured": True},
    {"name": "Bajaj NS200 CNC Ayna Seti", "slug": "bajaj-ns200-cnc-ayna",
     ...
     "image": "https://images.unsplash.com/photo-1429772011165-0c2e054367b8?w=600&q=80",
     "brand": "BAJAJ", "model": "NS200", "model_id": "bajaj-ns200",
     "year_range": "", "category": "Aksesuar", "stock": 16, "sku": "BJ-NS200-AY001",
