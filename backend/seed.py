...
from models.models import User, Product, Coupon, BankAccount, Category, Brand
...
DEMO_PRODUCTS = [
    ...
    {"name":"Honda PCX 125 Vites Kayışı (18-20)","slug":"honda-pcx125-1820-vites-kayisi","description":"Honda PCX 125 (2018-2020) için orijinal kalite aktarma kayışı. Uzun ömürlü kevlar takviyeli yapı.","price":425.00,"original_price":495.00,"image":"https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=600&q=80","brand":"HONDA","model":"PCX 125","model_id":"honda-pcx125-1820","year_range":"2018-2020","category":"Motor & Sanziman","stock":12,"sku":"HP-PCX-1820-VK001","oem_kodu":"23100-K35-V01","is_featured":True},
    {"name":"Honda PCX 125 Ön Far LED Set (18-20)","slug":"honda-pcx125-1820-on-far-led","description":"Honda PCX 125 (2018-2020) için yüksek ışık çıkışlı LED far seti. Kolay montaj, plug-and-play.","price":680.00,"original_price":None,"image":"https://images.unsplash.com/photo-1534755563369-ad37931ac77b?w=600&q=80","brand":"HONDA","model":"PCX 125","model_id":"honda-pcx125-1820","year_range":"2018-2020","category":"Elektrik & Aydinlatma","stock":6,"sku":"HP-PCX-1820-FL001","oem_kodu":"33100-K35-V01","is_featured":False},
    ...
    {"name":"Honda CBF 150 Zincir Dişli Seti","slug":"honda-cbf150-zincir-disli","description":"Honda CBF 150 için dayanıklı zincir ve dişli seti. O-ring zinciri ile uzun ömür.","price":650.00,"original_price":750.00,"image":"https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&q=80","brand":"HONDA","model":"CBF 150","model_id":"honda-cbf150","year_range":"","category":"Aktarma Organlari","stock":10,"sku":"HC-CBF-150-ZD001","oem_kodu":"40530-KPR-900","is_featured":True},
    {"name":"Honda FORZA 250 Arka Amortisör","slug":"honda-forza250-arka-amortisoru","description":"Honda FORZA 250 için yüksek performanslı ayarlanabilir arka amortisör. Konfor ve performansı birleştirir.","price":2850.00,"original_price":3200.00,"image":"https://images.unsplash.com/photo-1558981285-6f0c68243c5a?w=600&q=80","brand":"HONDA","model":"FORZA 250","model_id":"honda-forza250","year_range":"","category":"Suspansiyon","stock":4,"sku":"HF-FRZ-250-AA001","oem_kodu":"52400-MKA-J01","is_featured":True},
    {"name":"Honda ACTIVA 125 Karbüratör Sifonu","slug":"honda-activa125-karburator-sifonu","description":"Honda ACTIVA 125 için karbüratör bakım ve temizleme seti. Optimum yakıt-hava karışımı için.","price":185.00,"original_price":None,"image":"https://images.unsplash.com/photo-1429772011165-0c2e054367b8?w=600&q=80","brand":"HONDA","model":"ACTIVA 125","model_id":"honda-activa125","year_range":"","category":"Yakit Sistemi","stock":22,"sku":"HA-ACT-125-KS001","oem_kodu":"16100-KZL-J31","is_featured":False},
    ...
    {"name":"Yamaha NMAX 125 Buji Takımı","slug":"yamaha-nmax125-buji","description":"Yamaha NMAX 125 için iridyum uçlu buji takımı. Daha güçlü ateşleme, daha az yakıt tüketimi.","price":95.00,"original_price":None,"image":"https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=600&q=80","brand":"YAMAHA","model":"NMAX 125","model_id":"yamaha-nmax125","year_range":"","category":"Motor & Sanziman","stock":55,"sku":"YN-NMX-125-BJ001","oem_kodu":"BPR5ES-11","is_featured":False},
    {"name":"Yamaha NMAX 155 Akü 12V 7AH","slug":"yamaha-nmax155-aku","description":"Yamaha NMAX 155 için bakımsız 12V 7AH motosiklet aküsü. Soğuk havalarda güvenilir çalışma.","price":1250.00,"original_price":None,"image":"https://images.unsplash.com/photo-1429772011165-0c2e054367b8?w=600&q=80","brand":"YAMAHA","model":"NMAX 155","model_id":"yamaha-nmax155","year_range":"","category":"Elektrik & Aydinlatma","stock":9,"sku":"YN-NMX-155-AK001","oem_kodu":"GM7Z-3B","is_featured":False},
    ...
    {"name":"Bajaj NS200 Zincir Dişli Seti","slug":"bajaj-ns200-zincir-disli","description":"Bajaj NS200 için O-ring zincirli komple aktarma seti. Daha az bakım, daha uzun ömür.","price":580.00,"original_price":680.00,"image":"https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&q=80","brand":"BAJAJ","model":"NS200","model_id":"bajaj-ns200","year_range":"","category":"Aktarma Organlari","stock":14,"sku":"BJ-NS200-ZD001","oem_kodu":"2ML-F350Z-00","is_featured":True},
    {"name":"Bajaj NS200 LED Sinyal Seti","slug":"bajaj-ns200-led-sinyal","description":"Bajaj NS200 için tam LED sinyal lambası seti (4'lü). Güçlü görünürlük, uzun ömür.","price":420.00,"original_price":None,"image":"https://images.unsplash.com/photo-1534755563369-ad37931ac77b?w=600&q=80","brand":"BAJAJ","model":"NS200","model_id":"bajaj-ns200","year_range":"","category":"Elektrik & Aydinlatma","stock":25,"sku":"BJ-NS200-LS001","oem_kodu":"33400-MCA-S01","is_featured":False},
    {"name":"Bajaj NS200 Fren Balata Seti (On+Arka)","slug":"bajaj-ns200-fren-balata-seti","description":"Bajaj NS200 için komple ön ve arka fren balata takımı. Güvenli ve güçlü frenleme.","price":315.00,"original_price":380.00,"image":"https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=600&q=80","brand":"BAJAJ","model":"NS200","model_id":"bajaj-ns200","year_range":"","category":"Fren Sistemi","stock":18,"sku":"BJ-NS200-FB001","oem_kodu":"06435-MCA-J01","is_featured":True},
...
async def seed_products():
    async with AsyncSessionLocal() as session:
        try:
            ...
            await session.rollback()
            logger.warning(f"Ürün seeding sırasında uniqueness ihlali: {e}")
        except Exception as e:
            await session.rollback()
...
async def seed_coupons():
    async with AsyncSessionLocal() as session:
        try:
            ...
            await session.rollback()
            logger.warning(f"Kupon seeding sırasında uniqueness ihlali: {e}")
        except Exception as e:
            await session.rollback()
...
async def seed_categories_and_brands():
    """
    Mevcut Product tablosundaki tüm distinct brand/category değerlerini okuyup
    Category ve Brand tablolarına ekler. Her deploy'da çalışır, mevcut olanları atlar.
    Böylece ürün eklenince kategori/marka otomatik oluşur.
    """
    async with AsyncSessionLocal() as session:
        try:
            # Mevcut kategori adlarını al
            existing_cats = {r[0] for r in (await session.execute(select(Category.name))).all()}
            # Ürün tablosundaki distinct kategorileri al
            ...
            await session.commit()
            logger.info(f"Kategori/Marka sync: {added_cats} kategori, {added_brands} marka eklendi")

        except IntegrityError as e:
            await session.rollback()
            logger.warning(f"Kategori/Marka seeding uniqueness ihlali: {e}")
        except Exception as e:
            await session.rollback()
            logger.error(f"Kategori/Marka seeding hatası: {e}")
