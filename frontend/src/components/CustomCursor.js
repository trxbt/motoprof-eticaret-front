...
/* Sadece gerçek mouse olan cihazlarda göster (touch değil) */
const isTouchDevice = () =>
  ...
  return (
    <>
      <div ref={dotRef} style={{
        position: 'fixed', width: `${dotSize}px`, height: `${dotSize}px`,
        transform: 'translate(-50%, -50%)', background: '#f97316',
        borderRadius: '50%', pointerEvents: 'none', zIndex: 99999,
        willChange: 'left, top', transition: 'width 0.1s, height 0.1s',
